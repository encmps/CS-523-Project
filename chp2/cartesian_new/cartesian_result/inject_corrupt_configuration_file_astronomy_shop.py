...
from aiopslab.generators.fault.inject_corrupt_configuration_file import ConfigFileFaultInjector
...
class KafkaQueueProblemsBaseTask:
    def __init__(self):
        ...
        self.injector = ConfigFileFaultInjector(namespace=self.namespace)
