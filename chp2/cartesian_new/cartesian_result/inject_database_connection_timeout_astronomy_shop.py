...
from aiopslab.generators.fault.inject_database_connection_timeout import DatabaseConnectionTimeoutInjector
...
class KafkaQueueProblemsBaseTask:
    def __init__(self):
        ...
        self.injector = DatabaseConnectionTimeoutInjector(namespace=self.namespace)
